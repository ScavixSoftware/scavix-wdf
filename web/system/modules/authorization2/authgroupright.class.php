...
class AuthGroupRight extends System_Model
{
    function __construct(&$ds=null)
	{
		global $CONFIG;

		if( !isset($CONFIG['model']['authgroupright']) )
			$CONFIG['model']['authgroupright'] = 'group_rights';
	...
	public function GetSchemaDefinition()
	{
		...
		<table name="'.$this->_table.'">
			<field name="group_id" type="I" size="10"><KEY/></field>
