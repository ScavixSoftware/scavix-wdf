...
/**
 * Processes jQuery UI Themes.
 *
 * This task will translate a jQuery UI from the Themeroller into a LESS file plus some images.
 * Everything will be downloaded to a local folder.
 */
class jQueryTask extends \ScavixWDF\Tasks\Task
{
    ...
    function Run($args)
    {
        log_info("Valid syntax: jquery-updateui OR jquery-grabui");
    }
