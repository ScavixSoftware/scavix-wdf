...
function routing_ensure_table()
{
    global $CONFIG;
    if( !isset($_SESSION['routing']['ensure_table']))
    {
        $_SESSION['routing']['ensure_table'] = true;
        $sql = "CREATE TABLE IF NOT EXISTS url_routes (
        ...
        model_datasource($CONFIG['routing']['datasource'])->ExecuteSql($sql);
    }
}
